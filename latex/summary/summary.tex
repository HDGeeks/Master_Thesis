...
\begin{itemize}
    ...
    \item Titles vs.\ abstracts: Qwen3-8B favors titles, Claude favors abstracts, opposite directions. More context helping is model-dependent, not a fixed task property.
\end{itemize}
...
\begin{itemize}
    ...
    \item How to frame the 9B-is-the-sweet-spot finding in the thesis narrative?
\end{itemize}
